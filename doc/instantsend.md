...
This mechanism has been integrated into Bitcore-Node-usdecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/usdecoinpay/insight-api-usdecoin#web-socket-api](https://github.com/usdecoinpay/insight-api-usdecoin#web-socket-api) 
* API: [https://github.com/usdecoinpay/insight-api-usdecoin#instantsend-transactions](https://github.com/usdecoinpay/insight-api-usdecoin#instantsend-transactions) 
...
By default, the usdecoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the usdecoin Core daemon:
