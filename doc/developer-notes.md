...
usdecoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 44444.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 55555 for connections and services them.
...
However, in open source software such as usdecoin Core, where everyone uses
...
pay attention to for reviewers of usdecoin Core code.

General usdecoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: usdecoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
