...
Only requiring some minor changes is usdecoin.cpp.
...
Changes to usdecoin.cpp
----------------------
usdecoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
