...
{
    const char* pszTimestamp = "USDE IN THE WORLD 2014 -t 1508025600 01/01/2018";
    const CScript genesisOutputScript = CScript() << ParseHex("04ffff001d01042f5553444520494e2054484520574f524c442032303134202d7420313530383032353630302030312f30312f32303138") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 1 * 60 * 60; // usdecoin: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // usdecoin: 2.5 minutes
	...
	startNewChain = false;
        ...
        genesis = CreateGenesisBlock( 1530082057, 1534168, 0x1e0ffff0, 1, 50 * COIN);
	if(startNewChain == true) { MineGenesis(genesis, consensus.powLimit, true); }

        consensus.hashGenesisBlock = genesis.GetHash();

	if(!startNewChain) {
        assert(consensus.hashGenesisBlock == uint256S("0x00000d5052544a5244fe71f5692f8be55748e0092541e58385948a6bf6c8a0a3"));
        assert(genesis.hashMerkleRoot == uint256S("0x378d17fbf551d0466beab66b2e9169655ef18cb6934981054bf5130c834c45cc"));
	}
        ...
        // usdecoin addresses start with 'P'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,38);
        // usdecoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // usdecoin private keys start with '7' or 'P'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,150);
        // usdecoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // usdecoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // usdecoin BIP44 coin type is '5'
        nExtCoinType = 5;
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 24 * 60 * 60; // usdecoin: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // usdecoin: 2.5 minutes
        consensus.nPowMaxAdjustDown = 48; // 32% adjustment down
        consensus.nPowMaxAdjustUp = 32; // 16% adjustment up
        consensus.nUpdateDiffAlgoHeight = 0; // Algorithm fork block
	...
	startNewChain = false;
        ...
        genesis = CreateGenesisBlock(1530079582, 290003, 0x1e0ffff0, 1, 50 * COIN);
	...
	if(!startNewChain) {
        assert(consensus.hashGenesisBlock == uint256S("0x00000cbb5e5830820ed6b7276aaa2b380bba7f46adadaf4e58b7d527e8d9a73e"));
        assert(genesis.hashMerkleRoot == uint256S("0x378d17fbf551d0466beab66b2e9169655ef18cb6934981054bf5130c834c45cc"));
	}
        ...
        // Testnet usdecoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,38);
        // Testnet usdecoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet usdecoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet usdecoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet usdecoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        consensus.nGovernanceMinQuorum = 1000000;
	...
	startNewChain = false;
        ...
        genesis = CreateGenesisBlock(1530708148, 309809, 0x1e0ffff0, 1, 50 * COIN);
        if(startNewChain == true) {
        	MineGenesis(genesis, consensus.powLimit, true);
	}
	...
	if(!startNewChain) {
        assert(consensus.hashGenesisBlock == uint256S("0x0000083241a8d6b8cda390e7cf7efbea799789a5f3e5421c67f4d8c87f58b7ac"));
        assert(genesis.hashMerkleRoot == uint256S("0x378d17fbf551d0466beab66b2e9169655ef18cb6934981054bf5130c834c45cc"));
	}
        ...
        // Regtest usdecoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,38);
        // Regtest usdecoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest usdecoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest usdecoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest usdecoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
