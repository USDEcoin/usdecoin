...
#define BOOST_TEST_MODULE usdecoin Test Suite

#include "test_usdecoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_usdecoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
