...
extern CInstaPay instapay;

/*
    At 15 signatures, 1/2 of the masternode network can be owned by
    one party without comprimising the security of InstaPay
...
*/
static const int INSTAPAY_CONFIRMATIONS_REQUIRED = 6;
static const int DEFAULT_INSTAPAY_DEPTH          = 5;

static const int MIN_INSTAPAY_PROTO_VERSION      = 70206;

extern bool fEnableInstaPay;
extern int nInstaPayDepth;
...
private:
    ...
    bool IsInstaPayReadyToLock(const uint256 &txHash);

public:
    CCriticalSection cs_instapay;
    ...
    bool IsLockedInstaPayTransaction(const uint256& txHash);
