    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("usdecoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a usdecoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and usdecoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About usdecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about usdecoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for usdecoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your usdecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified usdecoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a usdecoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the usdecoin Core help message to get a list with possible usdecoin Core command-line options"));

    showPrivatePayHelpAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&PrivatePay information"), this);
    showPrivatePayHelpAction->setMenuRole(QAction::NoRole);
    showPrivatePayHelpAction->setStatusTip(tr("Show the PrivatePay basic information"));
    ...
    connect(showPrivatePayHelpAction, SIGNAL(triggered()), this, SLOT(showPrivatePayHelpClicked()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(showPrivatePayHelpAction);
    help->addSeparator();
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("usdecoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::showPrivatePayHelpClicked()
{
    if(!clientModel)
        return;
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to usdecoin network", "", count));
}
...
{
    QString strTitle = tr("usdecoin Core"); // default title
