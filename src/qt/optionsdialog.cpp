    ...
    mapper(0)
{
    ...
    /* Theme selector */
    //ui->theme->addItem(QString("USDE-light"), QVariant("light"));
    ui->theme->addItem(QString("USDE-blue"), QVariant("drkblue"));
    //ui->theme->addItem(QString("USDE-Crownium"), QVariant("crownium"));
    //ui->theme->addItem(QString("USDE-traditional"), QVariant("trad"));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->privatePayMultiSession, OptionsModel::PrivatePayMultiSession);
    mapper->addMapping(ui->spendZeroConfChange, OptionsModel::SpendZeroConfChange);
    mapper->addMapping(ui->privatePayRounds, OptionsModel::PrivatePayRounds);
    mapper->addMapping(ui->privatePayAmount, OptionsModel::PrivatePayAmount);
