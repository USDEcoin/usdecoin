...
const char *PPACCEPT="ppa";
const char *PPVIN="ppi";
const char *PPFINALTX="ppf";
const char *PPSIGNFINALTX="pps";
const char *PPCOMPLETE="ppc";
const char *PPSTATUSUPDATE="ppsu";
const char *PPTX="pptx";
const char *PPQUEUE="ppq";
const char *PPEG="ppeg";
...
const static std::string allNetMessageTypes[] = {
    ...
    NetMsgType::PPACCEPT,
    NetMsgType::PPVIN,
    NetMsgType::PPFINALTX,
    NetMsgType::PPSIGNFINALTX,
    NetMsgType::PPCOMPLETE,
    NetMsgType::PPSTATUSUPDATE,
    NetMsgType::PPTX,
    NetMsgType::PPQUEUE,
    NetMsgType::PPEG,
