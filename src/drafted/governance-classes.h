 ...
 *
 *   // network
 *   CusdecoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.usdecoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CusdecoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CusdecoinNetwork(UniValue objIn)
    {
...
// // can be under: usdecoinNetwork
// //   -- signature requirements : Key1(User)
// class CusdecoinNetworkVariable : public CGovernanceObject
// {
// private:
