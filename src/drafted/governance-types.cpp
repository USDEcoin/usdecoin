...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "usdecoinNetwork") type = usdecoinNetwork;
    if(strType == "usdecoinNetworkVariable") type = usdecoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == usdecoinNetwork) s = "usdecoinNetwork";
    if(type == usdecoinNetworkVariable) s = "usdecoinNetworkVariable";
