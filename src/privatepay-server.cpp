...
void CPrivatePayServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if(fLiteMode) return; // ignore all usdecoin related functionality
...
/*
    ...
    allow endless transaction that would bloat usdecoin and make it unusable. To
    stop these kinds of attacks 1 in 10 successful transactions are charged. This
    adds up to a cost of 0.001 USDE per transaction on average.
*/
...
void ThreadCheckPrivatePayServer()
{
    ...
    RenameThread("usdecoin-ps-server");
