...
/**
 * usdecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue instapaytoaddress(const UniValue& params, bool fHelp);
...
extern UniValue privatepay(const UniValue& params, bool fHelp);
