...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("usdecoin Core usdecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  usdecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded usdecoin transaction") + "\n" +
              "  usdecoin-tx [options] -create [commands]   " + _("Create hex-encoded usdecoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded usdecoin transaction
